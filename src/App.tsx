          ...
          {appState === 'CHOICE' && (
            ...
            >
              <button
                ...
                className="w-48 h-48 rounded-full border border-champagne-gold/40 flex items-center justify-center font-serif italic text-2xl text-white hover:bg-champagne-gold hover:text-black transition-all duration-500 shadow-[0_0_30px_rgba(255,105,180,0.1)] hover:shadow-[0_0_40px_rgba(255,105,180,0.4)]"
              >
                Message
              </button>
              <button
